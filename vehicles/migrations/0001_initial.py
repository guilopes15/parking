# Generated by Django 5.2 on 2025-04-26 23:14
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('licence_plate', models.CharField(max_length=10, unique=True, verbose_name='Placa')),
                ...
                ('vehicle_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='vehicle', to='vehicles.vehicletype', verbose_name='Tipo do Veiculo')),
            ],
            options={
