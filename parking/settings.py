...
SECRET_KEY = 'django-insecure-rhs*w11$%#=#9y=z--^0i9ztg7k-8f))t3rhafi3#%0b*!z-n#'
...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        ...
        'parkingspots.ParkingRecord': 'fa-solid fa-square-parking',
        'parkingspots.ParkingSpot': 'fa-solid fa-boxes-packing',
